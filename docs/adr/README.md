...
| [0007](0007-maskable-feature-blocks.md) | Support masked inputs with grouped feature blocks and block dropout | Accepted |
| [0008](0008-two-deployment-targets.md) | Ship a browser-only demo and a separate service deployment | Accepted, runtime superseded by 0012 |
...
| [0012](0012-browser-model-as-plain-javascript.md) | Run the browser model as a plain JavaScript port, not ONNX Runtime | Accepted |
